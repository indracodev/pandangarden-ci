...
<section class="content-header">
    <h1>
        Tb Category        <small>Edit Tb Category</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Tb Category</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/tb_category/edit_save/'.$this->uri->segment(4)), [
                        ...
                        <div class="form-group group-categoryId  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="categoryId" id="categoryId" placeholder="" value="<?= set_value('categoryId', $tb_category->categoryId); ?>">
                        ...
                        <div class="form-group group-categoryName  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="categoryName" id="categoryName" placeholder="" value="<?= set_value('categoryName', $tb_category->categoryName); ?>">
                                    <small class="info help-block">
                        ...
                        <div class="form-group group-menuId  ">
                                ...
                                <div class="col-sm-8">
                                    <textarea id="menuId" name="menuId" rows="10" cols="80"> <?= set_value('menuId', $tb_category->menuId); ?></textarea>
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
...
<script>
    ...
    $.ajax({
            url: form_tb_category.attr('action'),
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
        .done(function(res) {
            ...
            if (res.success) {
                var id = $('#tb_category_image_galery').find('li').attr('qq-file-id');
                if (save_type == 'back') {
