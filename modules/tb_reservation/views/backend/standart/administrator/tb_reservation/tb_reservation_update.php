...
<section class="content-header">
    <h1>
        Tb Reservation        <small>Edit Tb Reservation</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Tb Reservation</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/tb_reservation/edit_save/'.$this->uri->segment(4)), [
                        ...
                        <div class="form-group group-reservationId  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="reservationId" id="reservationId" placeholder="" value="<?= set_value('reservationId', $tb_reservation->reservationId); ?>">
                        ...
                        <div class="form-group group-reservationName  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="reservationName" id="reservationName" placeholder="" value="<?= set_value('reservationName', $tb_reservation->reservationName); ?>">
                                    <small class="info help-block">
                        ...
                        <div class="form-group group-reservationPhone  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="reservationPhone" id="reservationPhone" placeholder="" value="<?= set_value('reservationPhone', $tb_reservation->reservationPhone); ?>">
                                    <small class="info help-block">
                        ...
                        <div class="form-group group-reservationDate  ">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group date col-sm-8">
                                        <input type="text" class="form-control pull-right datepicker" name="reservationDate" placeholder="" id="reservationDate" value="<?= set_value('tb_reservation_reservationDate_name', $tb_reservation->reservationDate); ?>">
                                    </div>
                                    <small class="info help-block">
                                        </small>
                                </div>
                        ...
                        <div class="form-group group-reservationTime  ">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group date col-sm-8">
                                        <input type="text" class="form-control pull-right timepicker" name="reservationTime" id="reservationTime" value="<?= set_value('tb_reservation_reservationTime_name', $tb_reservation->reservationTime); ?>">
                                    </div>
                                    <small class="info help-block">
                                        </small>
                                </div>
                        ...
                        <div class="form-group group-reservationType  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="reservationType" id="reservationType" placeholder="" value="<?= set_value('reservationType', $tb_reservation->reservationType); ?>">
                                    <small class="info help-block">
                        ...
                        <div class="form-group group-reservationRequest  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="reservationRequest" id="reservationRequest" placeholder="" value="<?= set_value('reservationRequest', $tb_reservation->reservationRequest); ?>">
                                    <small class="info help-block">
...
<script>
    ...
    $.ajax({
            url: form_tb_reservation.attr('action'),
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
        .done(function(res) {
            ...
            if (res.success) {
                var id = $('#tb_reservation_image_galery').find('li').attr('qq-file-id');
                if (save_type == 'back') {
