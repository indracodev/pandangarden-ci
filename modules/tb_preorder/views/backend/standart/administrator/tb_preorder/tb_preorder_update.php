...
<section class="content-header">
    <h1>
        Tb Preorder        <small>Edit Tb Preorder</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Tb Preorder</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/tb_preorder/edit_save/'.$this->uri->segment(4)), [
                        ...
                        <div class="form-group group-preorderId  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="preorderId" id="preorderId" placeholder="" value="<?= set_value('preorderId', $tb_preorder->preorderId); ?>">
                        ...
                        <div class="form-group group-menuId  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="menuId" id="menuId" placeholder="" value="<?= set_value('menuId', $tb_preorder->menuId); ?>">
                                    <small class="info help-block">
                        ...
                        <div class="form-group group-preorderStart  ">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group date col-sm-8">
                                        <input type="text" class="form-control pull-right datepicker" name="preorderStart" placeholder="" id="preorderStart" value="<?= set_value('tb_preorder_preorderStart_name', $tb_preorder->preorderStart); ?>">
                                    </div>
                                    <small class="info help-block">
                                        </small>
                                </div>
                        ...
                        <div class="form-group group-preorderEnd  ">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group date col-sm-8">
                                        <input type="text" class="form-control pull-right datepicker" name="preorderEnd" placeholder="" id="preorderEnd" value="<?= set_value('tb_preorder_preorderEnd_name', $tb_preorder->preorderEnd); ?>">
                                    </div>
                                    <small class="info help-block">
                                        </small>
                                </div>
                        ...
                        <div class="form-group group-preorderStatus  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="preorderStatus" id="preorderStatus" placeholder="" value="<?= set_value('preorderStatus', $tb_preorder->preorderStatus); ?>">
                                    <small class="info help-block">
...
<script>
    ...
    $.ajax({
            url: form_tb_preorder.attr('action'),
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
        .done(function(res) {
            ...
            if (res.success) {
                var id = $('#tb_preorder_image_galery').find('li').attr('qq-file-id');
                if (save_type == 'back') {
