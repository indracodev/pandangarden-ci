...
<section class="content-header">
    <h1>
        Tb Visitorlog        <small><?= cclang('new', ['Tb Visitorlog']); ?> </small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
        ...
        <div class="col-md-12">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Tb Visitorlog']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
            ...
            <div class="col-sm-6">
                <div class="input-group date col-sm-8">
                    <input type="text" class="form-control pull-right datepicker" name="tb_visitorlog_date" placeholder="Tb Visitorlog Date" id="tb_visitorlog_date">
                </div>
    ...
    <div class="form-group group-tb_visitorlog_ip ">
        <div class="form-group group-tb_visitorlog_ip ">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="tb_visitorlog_ip" id="tb_visitorlog_ip" placeholder="Tb Visitorlog Ip" value="<?= set_value('tb_visitorlog_ip'); ?>">
                <small class="info help-block">
    ...
    <div class="form-group group-tb_visitorlog_client ">
        <div class="form-group group-tb_visitorlog_client ">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="tb_visitorlog_client" id="tb_visitorlog_client" placeholder="Tb Visitorlog Client" value="<?= set_value('tb_visitorlog_client'); ?>">
                <small class="info help-block">
    ...
    <div class="form-group group-tb_visitorlog_times ">
            ...
            <div class="col-sm-8">
                <input type="number" class="form-control" name="tb_visitorlog_times" id="tb_visitorlog_times" placeholder="Tb Visitorlog Times" value="<?= set_value('tb_visitorlog_times'); ?>">
                <small class="info help-block">
    ...
    <div class="form-group group-tb_visitorlog_lastvisit ">
            ...
            <div class="col-sm-6">
                <div class="input-group date col-sm-8">
                    <input type="text" class="form-control pull-right datetimepicker" name="tb_visitorlog_lastvisit" id="tb_visitorlog_lastvisit">
                </div>
                <small class="info help-block">
                    </small>
            </div>
...
<script>
    ...
    $.ajax({
            url: BASE_URL + '/administrator/tb_visitorlog/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
